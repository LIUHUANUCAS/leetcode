...
/**
    Solutions:
        ...
        Therefore, we only need to consider factors up to ¡Ìn because, if n is divisible by some number p,
        then n = p ¡Á q and since p ¡Ü q, we could derive that p ¡Ü ¡Ìn.
        ...
        Then we look at the next number, 3. Similarly, all multiples of 3 such as 3 ¡Á 2 = 6, 3 ¡Á 3 = 9, ...
         must not be primes, so we mark them off as well. Now we look at the next number, 4, which was already marked off.
          What does this tell you? Should you mark off all multiples of 4 as well?

        4 is not a prime because it is divisible by 2, which means all multiples of 4 must also be divisible by 2 and
         were already marked off. So we can skip 4 immediately and go to the next number, 5. Now, all multiples of 5 such as

         5 ¡Á 2 = 10, 5 ¡Á 3 = 15, 5 ¡Á 4 = 20, 5 ¡Á 5 = 25, ... can be marked off. There is a slight optimization here,
          we do not need to start from 5 ¡Á 2 = 10. Where should we start marking off?

        In fact, we can mark off multiples of 5 starting at 5 ¡Á 5 = 25, because 5 ¡Á 2 = 10 was already marked off by
         multiple of 2, similarly 5 ¡Á 3 = 15 was already marked off by multiple of 3. Therefore, if the current number is p,
